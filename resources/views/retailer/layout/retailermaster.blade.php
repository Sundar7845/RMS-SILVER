...
@endif -->
    ...
    <a class="no-login-required" style=" position: fixed; bottom: 100px; right: 10px; z-index: 9999; "
        target="_blank"
        ...
        <img src="{{ asset('retailer/assets/img/whatsapp.png') }}" width="64" height="64"
            alt="whatsapp icon">
    </a>
    ...
    <!--
    <div id="whatsapp-contact" style="cursor: pointer; position: fixed; bottom: 100px; right: 10px; z-index: 9999; ">
        <img src="{{ asset('retailer/assets/img/whatsapp.png') }}" width="64" height="64"
            alt="whatsapp icon">
    </div> -->
    <!-- <script>

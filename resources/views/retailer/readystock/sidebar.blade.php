<section class="col-lg-3 col-xxl-2 d-none d-lg-block p-lg-2">
    ...
    <div class="row g-0">
        ...
        <input type="hidden" name="boxFilter" id="boxFilter"
            value="{{ in_array($currentProjectId, $validProjects) ? $boxes->toJson() : '[]' }}">
...
<script>
    ...
    function generateInputElements(filterName, data) {
        ...
        let showAllBtn = document.getElementById(`show-all-${filterName}`);
        if (showAllBtn) {
            showAllBtn.style.display = data.length > 10 ? "block" : "none";
        }
